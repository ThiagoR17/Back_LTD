					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="POST" action="" enctype="multipart/form-data">
								...
								<div class="form-group">
									<input type="checkbox" class="checkbox-hack" id="checkbox1">
    							<label for="checkbox1">Evento Confirmado</label>
								<input type="checkbox" class="checkbox-hack" id="checkbox2">
    						<label for="checkbox2">Evento não Confirmado</label>
								</div>
					...
					<div class="modal-body">
						<form method="POST" action="" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<textarea name="hora" class="form-control" id="detalhes-text"></textarea>
							</div>
							<div class="form-group">
								<label for="message-text" class="control-label">Hora:</label>
								<textarea name="data" class="form-control" id="detalhes-text"></textarea>
							</div>
							<div class="form-group">
							<input type="checkbox" class="checkbox-hack" id="checkbox1">
    						<label for="checkbox1">Evento Confirmado</label>
